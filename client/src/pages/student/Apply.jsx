...
import { submitApplication } from "@/actions/applicationAction";
...
function Apply() {
  ...
  const { programs, loading: programsLoading, isLoaded: programsLoaded } = useSelector((state) => state.program);
  ...
  useEffect(() => {
    if (!programsLoading && !programsLoaded) {
      dispatch(fetchPrograms());
    }
  }, [dispatch, programsLoading, programsLoaded]);
