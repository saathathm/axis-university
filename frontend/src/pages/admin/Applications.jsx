...
import { approveAdminApplication, fetchAdminApplications, rejectAdminApplication } from "@/store/slices/applicationSlice.js";
...
const Applications = () => {
  ...
  const approve = (id) => dispatch(approveAdminApplication(id)).unwrap();
  const reject = (id) => dispatch(rejectAdminApplication({ applicationId: id, admin_note: notes[id] || "Rejected by admin." })).unwrap();
